...
public class frmChiTietTienNghi extends JPanel implements ActionListener{
	...
	public frmChiTietTienNghi()
	{
		...
		boxSearch.add(Box.createHorizontalStrut(680));
		btnThem = new JButton("Thêm chi tiet tien nghi");
		...
		//table
		String column[] = { "Ma chi tiet tien nghi","So phong","Ten tien nghi", "So luong" };
